...
/**
 * This kernel is invoked by CutoffAngleForce to calculate the forces acting on the system and the energy of the system.
 */
    class CommonCalcCutoffAngleForceKernel : public CalcCutoffAngleForceKernel {
    public:
        CommonCalcCutoffAngleForceKernel(std::string name, const Platform& platform, ComputeContext& cc, const System& system) : CalcCutoffAngleForceKernel(name, platform),
                                                                                                                                   hasInitializedKernel(false), cc(cc), system(system) {
        }
        /**
         * Initialize the kernel.
